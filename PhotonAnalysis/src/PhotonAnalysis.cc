...
bool PhotonAnalysis::TTHleptonicTag2012(LoopAll& l, int& diphotonTTHlep_id, float* smeared_pho_energy, float phoidMvaCut,bool *jetid_flags, bool mvaselection,bool vetodipho,bool kinonly){
    //francesco 
    bool tag = false;
